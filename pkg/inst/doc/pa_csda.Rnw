...
active return. The two
most common approaches are the Brinson model and a regression-based
...
examples based on real-world data from MSCI Barra's Global Equity
