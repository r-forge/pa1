...
<<>>=
data(JanGEM2)
br.single <- brinson(JanGEM2, date.var = "date", sector.var = "sector", 
...
both the portfolio and the universe by sector in Jan, 2010. This
...
<<>>=
br.multi <- brinson(GEM2, date.var = "date", sector.var = "sector", 
                    bench.weight = "benchmark", portfolio.weight = "portfolio", 
                    ret.var = "return")
...
shows the exposure of the portfolio and the universe by sector as
...
interaction among various variables including \texttt{sector},
